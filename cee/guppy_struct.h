#ifndef __GUPPY_CEE_STRUCT_H__
#define __GUPPY_CEE_STRUCT_H__
/*	
 *  Copyright (C) 2012
 ...
 *
 */
#define SCM_MMR_OBJ_GETTER( obj, cm, gm, c_scm )			\
  SCM_DEFINE( scm_mmr_##obj##_get_##cm, "rag-" #obj ":" #gm,		\
	      1, 0, 0,							\
	      (SCM smob),						\
  ...
  {									\
    ...
    obj = (scm_mmr_##obj *)SCM_SMOB_DATA( smob );			\
    return (c_scm( obj->cm ));						\
  }
#define SCM_MMR_OBJ_SETTER( obj, cm, gm, c_scm, scm_c )			\
  SCM_DEFINE( scm_mmr_##obj##_set_##cm, "rag-" #obj ":" #gm "-set!",	\
	      2, 0, 0,							\
	      (SCM smob,						\
	       SCM value),						\
...
#define SCM_MAKE_GSUBR_OBJ_GET( obj, x ) \
  scm_c_define_gsubr( s_scm_mmr_##obj##_get_##x, 1, 0, 0, \
                        scm_mmr_##obj##_get_##x )

#define SCM_MAKE_GSUBR_OBJ_SET( obj, x ) \
  scm_c_define_gsubr( s_scm_mmr_##obj##_set_##x, 2, 0, 0, \
                        scm_mmr_##obj##_set_##x )

#endif // End of __GUPPY_CEE_STRUCT_H__;
